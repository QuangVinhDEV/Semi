...
public function request(Request $request, MailerInterface $mailer, ManagerRegistry $doctrine, CartManager $cartManager): Response
{
...
public function checkEmail(ManagerRegistry $doctrine, CartManager $cartManager): Response
{
    $categories = $doctrine->getRepository(Category::class)->findAll();
    $cart = $cartManager->getCurrentCart();
...
private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
{
    ...
    $email = (new TemplatedEmail())
        ->from(new Address('235371vinhtran@gmail.', 'Tran Quang Vinh'))
        ->to($user->getEmail())
